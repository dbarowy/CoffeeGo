# Modified from:
# https://github.com/kschiess/loaded_dice
...
class MyDie
  ...
  #
  def initialize(seed, *probabilities)
    init(seed, *probabilities)
  end
  def init(seed, *probabilities) # :nodoc: 
    @rng = Random.new(seed)
